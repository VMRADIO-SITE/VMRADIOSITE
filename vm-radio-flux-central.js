/* VM RADIO — source unique moteur + flux v13 */
(function(){
'use strict';
...
if(window.__VMRADIO_CENTRAL_V13__)return;
window.__VMRADIO_CENTRAL_V13__=true;
...
function loadRequestUi(){if(window.VMRADIO_OPEN_REQUEST_CATALOG)return;if(document.querySelector('script[data-vm-request-ui]'))return;const s=document.createElement('script');s.src='music-requests-ui.js?v=20260827-requester2';s.async=false;s.dataset.vmRequestUi='1';document.head.appendChild(s)}
